        ...
        <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl p-8 md:p-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p className="">With over three decades of experience serving the San Jose community, Khalsa Dental Care has built a reputation for providing exceptional dental care that combines advanced technology with a calm, compassionate approach. The Exceptional Dentistry Registry wrote that our clinic is "an example of “Exceptional Patient Safety and Dental Office compliance!"
